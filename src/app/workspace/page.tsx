...
// The "classic workspace" — the v1 single-page authoring surface (example hero +
// golden-set builder + Inspector + RAG toggle). Re-homed from `/` to `/workspace`
// in R17 so the root can become a persona-routing landing; the workspace itself is
// unchanged (route-only move). Linked quietly from the landing as practitioner depth.
export default function WorkspacePage() {
  ...
  return (
    <>
      {/* Quiet way back to the landing front door. */}
      <div
        style={{
          maxWidth: 1100,
          margin: '0 auto',
      ...
      >
        <Link href="/" data-testid="workspace-home-link" style={{ fontSize: '0.85rem' }}>
          ← Eval Sandbox home
        </Link>
      </div>
